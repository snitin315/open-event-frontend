      ...
      this.onValid(() => {
        ...
        if (this.token) {
          ...
          this.loader
            ...
            .then(() => {
              this.notify.success(
                this.l10n.t('Your password has been reset successfully. Please log in to continue'),
                {
                  id: 'reser_succ'
                }
              );
          ...
          this.loader
            ...
            .then(() => {
              this.notify.success(
                this.l10n.t('Please go to the link sent to your email to reset your password'),
                {
                  id: 'reset_link_sent'
                }
              );
            ...
            .catch((reason) => {
              if (
                ...
                reason.errors[0].status === 404
              ) {
                console.warn('Reset Password: No user account found', reason);
                this.set(
                  'errorMessage',
                  this.l10n.t('No account is registered with this email address.')
                );
              } else {
