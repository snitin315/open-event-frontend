  ...
  acceptProposal(session_id, sendEmail) {
    ...
    session
      ...
      .then(() => {
        sendEmail
          ? this.notify.success(
              this.l10n.t('Session has been accepted and speaker has been notified via email.'),
              {
  ...
  confirmProposal(session_id, sendEmail) {
    ...
    session
      ...
      .then(() => {
        sendEmail
          ? this.notify.success(
              this.l10n.t('Session has been confirmed and speaker has been notified via email.'),
              {
  ...
  rejectProposal(session_id, sendEmail) {
    ...
    session
      ...
      .then(() => {
        sendEmail
          ? this.notify.success(
              this.l10n.t('Session has been rejected and speaker has been notified via email.'),
              {
