...
export default class extends Controller.extend(EmberTableControllerMixin) {
  @or('authManager.currentUser.isSuperAdmin', 'authManager.currentUser.isAdmin')
  hasRestorePrivileges;
  ...
  async togglePromoted(event_id) {
    ...
    try {
      ...
      await event.save();
      this.notify.success(
        this.l10n.t(`Event ${event.isPromoted ? 'Promoted' : 'unpromoted'} Successfully`),
        {
          id: 'event_detail_changed'
        }
      );
