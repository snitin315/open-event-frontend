...
export const compulsoryProtocolValidUrlPattern = new RegExp(
...
export const validTwitterProfileUrlPattern = new RegExp(
  '^(https?:\\/\\/)' + '?(?:www.)?twitter\\.com\\/([a-zA-Z0-9_]+)$' // compulsory protocol
);

export const validFacebookProfileUrlPattern = new RegExp(
  '^(https?:\\/\\/)' + '?(?:www.)?(facebook|fb)\\.com\\/([a-zA-Z0-9_.]+)$' // compulsory protocol
);

export const validGithubProfileUrlPattern = new RegExp(
  '^(https?:\\/\\/)' + '?(?:www.)?github\\.com\\/([a-zA-Z0-9_]+)([-]?)([a-zA-Z0-9_]+)$' // compulsory protocol
);
